    ...
    <div class="container">
      <div class="modal">
        <div class="modal-header">
          <h3>{{ name }}, {{ country }}</h3>
          <svg @click="this.$router.go(-1)" width="83" height="46" viewBox="0 0 83 46" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M81.1725 25.1213C82.3441 23.9497 82.3441 22.0503 81.1725 20.8787L62.0807 1.7868C60.9091 0.615223 59.0096 0.615223 57.838 1.7868C56.6664 2.95837 56.6664 4.85786 57.838 6.02944L74.8086 23L57.838 39.9706C56.6664 41.1421 56.6664 43.0416 57.838 44.2132C59.0096 45.3848 60.9091 45.3848 62.0807 44.2132L81.1725 25.1213ZM0.94873 26H79.0512V20H0.94873V26Z" fill="#6A6A6A" fill-opacity="0.3"/>
          </svg>
        </div>
